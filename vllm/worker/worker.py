...
class Worker:
    ...
    def cache_swap(
        ...
        if blocks_to_swap_in:
            self.cache_engine.swap_in(blocks_to_swap_in, swap_id)
        if blocks_to_swap_out:
            self.cache_engine.swap_out(blocks_to_swap_out, swap_id)
        if blocks_to_copy:
            self.cache_engine.copy(blocks_to_copy)

    def check_finished_events(self) -> Tuple[List[str], List[str]]:
        return self.cache_engine.check_finished_events()
